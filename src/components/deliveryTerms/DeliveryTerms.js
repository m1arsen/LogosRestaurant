  ...
  return (
    <section class="delivery-terms">
      <div class="container">
        ...
        <div class="delivery-terms__container">

          <div class="delivery-terms__accordion">

            <div class="delivery-terms__accordion_item" data-tab="#accordion-tab_1">

              <div class="delivery-terms__accordion_btn">
                <p>У наших курьеров всегда должна быть сдача!</p>
                <img class="delivery-terms__accordion_icon" src={accordionIcon} alt="accordion-icon"/>
              </div>

              <div class="delivery-terms__accordion_info" id="accordion-tab_1">
                <p>При оплате наличными будьте уверены, что у нашего курьера всегда будет сдача.</p>
              </div>

            </div>

            <div class="delivery-terms__accordion_item" data-tab="#accordion-tab_2">
              ...
              <div class="delivery-terms__accordion_info" id="accordion-tab_2">
            ...
            <div class="delivery-terms__accordion_item active" data-tab="#accordion-tab_3">
              ...
              <div class="delivery-terms__accordion_info active" id="accordion-tab_3">
                <p>В случае если клиенту не понравится наш продукт мы вернем стоимость продукта !</p>
              </div>

            </div>

            <div class="delivery-terms__accordion_item" data-tab="#accordion-tab_4">
              ...
              <div class="delivery-terms__accordion_info" id="accordion-tab_4">
                <p>При появлении замечаний вы можете обратится в нашу тех. поддержку и мы выслушаем все замечания.</p>
              </div>

            </div>

            <div class="delivery-terms__accordion_item" data-tab="#accordion-tab_5">
              ...
              <div class="delivery-terms__accordion_info" id="accordion-tab_5">
                <p>Доступные все платежные системы Visa, MasterCard и МИР.</p>
              </div>

            </div>

            <div class="delivery-terms__accordion_item" data-tab="#accordion-tab_6">
              ...
              <div class="delivery-terms__accordion_info" id="accordion-tab_6">
        ...
        <div class="delivery-terms__info">
          <div class="delivery-terms__info_delivery">
            <h2>График работы доставки:</h2>
            <p>с 10:00-21:00</p>
          </div>
          <div class="delivery-terms__info_cafe">
            <h2>График работы кафе:</h2>
            <p>с 08:00-21:00</p>
          </div>
        </div>

        <div class="delivery-terms__order">
