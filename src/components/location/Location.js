    ...
    <section className="location">
      <div className="location__container container">
        <div className="location__contacts">
          ...
          <h1 className="location__title">Контакты</h1>

          <div className="location__text-info">

            <div className="location__adress-section">
              <p className="location__adress-section-title">Наш адрес:</p>
              <p className="location__adress-section-adress">МО, городской округ Красногорск, село Ильинкое, Экспериментальная улица, 10</p>
            </div>

            <div className="location__mail-section">
              <p className="location__mail-section-title">Наша почта:</p>
              <a className="location__mail-section-mail" href="mailto:auto.wash@gmail.com">auto.wash@gmail.com</a>
            </div>

          </div>

          <div className="location__btns">
            <button className="location__btns-book">Забронировать стол</button>
            <div className="location__number">
              <a href="tel:79175105759" className="location__num">+7 (917) 510-57-59</a>
          ...
          <div className="location__socials">
            ...
            <div className="location__links">
              <a className="location__links-facebook" href="https://facebook.com/" target="_blank">
              ...
              <a className="location__links-vk" href="https://vk.com/" target="_blank">
              ...
              <a className="location__links-youtube" href="https://youtube.com/" target="_blank">
                <svg width="20" height="19" fill="white">
              ...
              <a className="location__links-instagram" href="https://instagram.com/" target="_blank">
                <svg width="19" height="19" fill="white">
