    ...
    <section class="location">
      <div class="location__container container">
        <div class="location__contacts">
          ...
          <h1 class="location__title">Контакты</h1>

          <div class="location__text-info">

            <div class="location__adress-section">
              <p class="location__adress-section-title">Наш адрес:</p>
              <p class="location__adress-section-adress">МО, городской округ Красногорск, село Ильинкое, Экспериментальная улица, 10</p>
            </div>

            <div class="location__mail-section">
              <p class="location__mail-section-title">Наша почта:</p>
              <a class="location__mail-section-mail" href="mailto:auto.wash@gmail.com">auto.wash@gmail.com</a>
            </div>

          </div>

          <div class="location__btns">
            <button class="location__btns-book">Забронировать стол</button>
            <div class="location__number">
              <a href="tel:79175105759" class="location__num">+7 (917) 510-57-59</a>
          ...
          <div class="location__socials">
            ...
            <div class="location__links">
              <a class="location__links-facebook" href="https://facebook.com/" target="_blank">
              ...
              <a class="location__links-vk" href="https://vk.com/" target="_blank">
              ...
              <a class="location__links-youtube" href="https://youtube.com/" target="_blank">
                <svg width="20" height="19" fill="white">
              ...
              <a class="location__links-instagram" href="https://instagram.com/" target="_blank">
                <svg width="19" height="19" fill="white">
